...
class Log:
    def __init__(self, name=None, log_path=None, gap=8):
        ...
        class or just modify these parameters if you  want to change any configs. And more configs will be added in the future.
        ...
        :param gap:             timezone diff from UTC to local timezone
                                For example: if your location is Asia/Beijing, then gap should be 8 (GTM + 8)
        """
        # 0 - 50
    ...
    def combine(*msg, depth=3):
        ...
        In this func, message from log will be combined into the format that builtin func log needs, and for convenience as well.
